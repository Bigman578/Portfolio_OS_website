        ...
        <>
            <div className="main-prevWork">
                <div className="introduction-prevWork">
                    <h3>All projects</h3>
                    <p>Any bigger project that is not planned by myself compiled with date, ordering individual and final product</p>
                </div>
                <div className="allProjects">
                    <div className="prevWork-display">
                        ...
                        <p style={{fontStyle: 'italic'}}>2023-2024, Sankta Marie Skolan</p>
